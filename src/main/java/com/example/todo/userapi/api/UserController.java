...
public class UserController {
    ...
    public ResponseEntity<?> loadFile(
        ...
        try {
            ...
            // 응답 데이터 헤더를 설정해야 하는 경우도 있음
            // 응답헤더의 기본값은 JSON 따라서 이미지 파일을 보낼땐 header 설정 필요
            // 3. 응답헤더에 컨텐츠 타입을 설정
...
//            headers.set("Content-type", "application/json"); // 기본값이 이거임
    ...
    private MediaType findExtensionAndGetMediaType(String filePath) {
        ...
        // 파일 경로에서 확장자 추출하기
        // D:/todo_upload/afsdjfkjkl_target.jpg
